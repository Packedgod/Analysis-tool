...
This skill exports a Vantage strategy to **all major trading platforms** in one go.
...
```pinescript
// This strategy was generated by Vantage
...
When generating code, map Vantage instrument codes appropriately:

| Vantage | TradingView | 通达信/同花顺 | MT5 |
|-------------|-------------|---------------|-----|
...
- [ ] Comment header notes the original Vantage run_id and instrument
