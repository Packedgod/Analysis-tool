...
Output:
    ~/.vantage/reports/alpha_bench_*.html      — per-run HTML reports
    ~/.vantage/reports/bench_<zoo>_<uni>.json  — per-run raw results
    ~/.vantage/reports/bench_summary.json      — aggregate summary
...
REPORTS_DIR = Path.home() / ".vantage" / "reports"
